...
- **n8n Instance**: n8n Cloud (`abudii.app.n8n.cloud`)
...
|--------|---------|---------|
| **n8n-mcp** | `n8n-mcp` | n8n workflow management, node search, validation, templates, executions |
| **github** | `@modelcontextprotocol/server-github` | GitHub integration — repos, issues, PRs |
